...
LABEL_NAMES = ['jumping', 'climbingup', 'climbingdown', 'lying', 'running', 'sitting', 'standing', 'walking']
...
for datafile in tqdm(glob.glob(DATAFILES)):
    ...
    data = np.load(datafile)[:, start_ind: start_ind+3] # data corresponding to forearm
